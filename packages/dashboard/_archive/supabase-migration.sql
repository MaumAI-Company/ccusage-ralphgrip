...
-- 7b. utilization_snapshots 테이블: Claude 사용률 스냅샷
...
ALTER TABLE utilization_snapshots
  ADD COLUMN IF NOT EXISTS five_hour_resets_at TIMESTAMPTZ;
...
-- 8. RPC 함수: 최신 utilization snapshot
...
RETURNS TABLE (
  ...
  "fiveHourResetsAt" TIMESTAMPTZ,
  "sevenDayResetsAt" TIMESTAMPTZ,
  ...
  SELECT DISTINCT ON (us.member_id)
    ...
    us.five_hour_resets_at AS "fiveHourResetsAt",
    us.seven_day_resets_at AS "sevenDayResetsAt",
